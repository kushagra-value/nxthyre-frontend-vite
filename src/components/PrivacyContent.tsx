...
const dummyContent = Array.from({ length: 50 }, (_, i) => `Dummy paragraph ${i + 1}: This is some placeholder text for the privacy policy. Read all the document carefully.`).join('\n\n');
