      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 space-y-4 h-fit">
        ...
        <div>
          ...
          <textarea
            ...
            className={`w-full px-3 py-2 border-l border-r border-b border-gray-300 shadow-xl rounded-b-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none ${
