    ...
    const handleLinkedInCallback = async () => {
      try {
        ...
        if (!code) {
          ...
          const linkedInAuthUrl = `https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=YOUR_LINKEDIN_CLIENT_ID&redirect_uri=${encodeURIComponent(window.location.origin + '/auth/linkedin')}&scope=r_liteprofile%20r_emailaddress`;
          ...
          <div className="bg-white rounded-2xl p-8 shadow-2xl">
            ...
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-gray-900 flex items-center">
                LinkedIn Authentication <Sparkles className="w-6 h-6 ml-2 text-yellow-400" />
              </h2>
            </div>
              ...
              {authStatus === 'loading' && (
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600">Please wait while we connect to LinkedIn</p>
                  </div>
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <p className="text-sm text-blue-700">
                      You may be redirected to LinkedIn to complete the authentication
                    </p>
                  </div>
                </div>
              )}
              ...
              {authStatus === 'error' && (
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600">We couldn't connect to your LinkedIn account</p>
                  </div>
                  <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                    <p className="text-sm text-red-700">
                      This could be due to network issues or LinkedIn being temporarily unavailable
                    </p>
                  </div>
