          ...
          <div className="w-full max-w-md">
            <div className="bg-white rounded-2xl p-8 shadow-2xl text-center">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center justify-center">
                Check Your Email <Sparkles className="w-6 h-6 ml-2 text-yellow-400" />
              </h2>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-2xl">
            ...
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-gray-900 flex items-center">
                Forgot Password <Sparkles className="w-6 h-6 ml-2 text-yellow-400" />
              </h2>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-sm text-blue-700 text-center">
                  ...
                  Use <span className="font-semibold">admin@admin.com</span> or <span className="font-semibold">team@team.com</span> for demo
                </p>
              </div>
            </form>
