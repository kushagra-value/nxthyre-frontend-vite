        ...
        <div className="relative bg-white rounded-xl shadow-sm px-8 py-6">
            <div className="flex items-center justify-between pl-8">
                <div className="space-y-3">
                    <div className="h-7 w-72 bg-gray-100 rounded"></div>
    ...
    <div className="w-96 h-[80vh] min-h-max">
        <div className="bg-[#F5F9FB] h-full rounded-lg p-4 space-y-4">
            <SkeletonWrapper loading={true}>
                {/* Stage Header */}
                <div className="space-y-3">
                    <div className="h-6 w-32 bg-gray-200/60 rounded"></div>
                    <div className="h-4 w-28 bg-gray-200/60 rounded"></div>
                </div>

                {/* Stats */}
                <div className="flex items-center justify-between py-2">
                    <div className="h-5 w-20 bg-gray-200/60 rounded"></div>
                    <div className="h-5 w-20 bg-gray-200/60 rounded"></div>
                </div>

                {/* Progress Bar */}
                <div className="w-full bg-white/80 h-2 rounded-full overflow-hidden">
                    <div className="bg-gray-200/60 h-2 rounded-full w-3/4"></div>
                </div>
            </SkeletonWrapper>
                ...
                {[...Array(5)].map((_, weekIndex) => (
                    <div key={weekIndex} className="grid grid-cols-7 gap-2">
                        {[...Array(7)].map((_, dayIndex) => (
                            <div key={dayIndex} className="h-20 bg-gray-50 rounded-lg"></div>
                        ))}
                    </div>
                ))}
            </div>
                                ...
                                <div className="w-96 h-[80vh] min-h-max bg-[#F5F9FB] rounded-lg flex flex-col items-center justify-center">
                                    <SkeletonWrapper loading={true}>
                                        <div className="space-y-3 flex flex-col items-center">
                                            <div className="w-14 h-14 bg-gray-200/60 rounded-full"></div>
                ...
                <div className="max-w-4xl mx-auto space-y-4">
                    ...
                    {[...Array(3)].map((_, i) => (
                        <div key={i} className="bg-white rounded-3xl shadow-sm p-8 mx-8">
                            <div className="h-5 w-32 bg-gray-100 rounded mb-4"></div>
                            <div className="space-y-2">
        ...
        <SkeletonWrapper loading={true}>
            <div className="bg-white w-full max-w-xl shadow-2xl rounded-3xl overflow-hidden p-6">
                ...
                <div className="text-center mb-6 space-y-2">
                    <div className="h-5 w-56 bg-gray-100 rounded mx-auto"></div>
