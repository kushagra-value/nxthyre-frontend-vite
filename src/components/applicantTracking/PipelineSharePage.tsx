        ...
        <div className="pl-8">
          ...
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center gap-1.5 bg-green-50 text-green-600 px-2.5 py-1 rounded-full">
              <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="14.9688" height="14.9688" rx="7.48438" fill="#A8E8CD" />
                <path d="M2.49609 9.28995C2.49609 9.28995 4.46314 6.58449 5.61458 6.21505C6.76603 5.84562 7.80041 9.83024 9.78856 9.28995C11.3424 8.86769 12.4753 5.61328 12.4753 5.61328" stroke="#1CB977" stroke-linecap="round" />
              </svg>
          ...
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-1.5 text-gray-600">
              <svg width="13" height="15" viewBox="0 0 13 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <rect x="5" y="4" width="3" height="11" rx="1.5" fill="#1CB977" />
          ...
          <div className="flex justify-between items-center text-sm text-gray-600 mb-2">
            <div className="flex items-center gap-1" title="Total Experience">
              ...
              <span>{candidate.total_experience ? `${candidate.total_experience} years` : "-- year"}</span>
            </div>
            <div className="flex items-center gap-1" title="Current Salary">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M7.91493 14.1684C7.91493 14.6892 7.7691 15.1823 7.51216 15.599C7.03299 16.4045 6.15104 16.9462 5.13715 16.9462C4.12326 16.9462 3.24131 16.4045 2.76215 15.599C2.5052 15.1823 2.35938 14.6892 2.35938 14.1684C2.35938 12.6337 3.60243 11.3906 5.13715 11.3906C6.67187 11.3906 7.91493 12.6337 7.91493 14.1684Z" stroke="#818283" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M4.05469 14.1649L4.74218 14.8524L6.22135 13.4844" stroke="#818283" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M3.05469 12.2925V7.91753C3.05469 5.48698 4.44358 4.44531 6.52691 4.44531H13.4714C15.5547 4.44531 16.9436 5.48698 16.9436 7.91753V12.0842C16.9436 14.5148 15.5547 15.5564 13.4714 15.5564H7.56858" stroke="#818283" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
              </svg>

              <span>{candidate.current_salary ? `${candidate.current_salary}` : "-- LPA"}</span>
            </div>
            <div className="flex items-center gap-1" title="Expected Salary">
              ...
              <span>{candidate.expected_salary ? `${candidate.expected_salary} LPA` : "-- LPA"}</span>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center text-sm text-gray-600 mb-4">
            ...
            <div className="flex items-center gap-1" title="Applied">
              ...
              <span>{candidate.time_added ? `${candidate.time_added}` : "-- days ago"}</span>
            </div>
            <div>
            </div>
          </div>
