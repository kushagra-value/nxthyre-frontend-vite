                  ...
                  <div className="bg-gray-50 min-h-screen">
                    ...
                    <div className="max-w-full mx-auto px-3 py-2 lg:px-6 lg:py-3 ">
                      ...
                      <div className="flex w-full gap-3 h-full">
                        <div className="3xl:w-[25%] sticky order-1 lg:order-1 top-16 self-start will-change-transform z-10">
                          <FiltersSidebar
                            filters={filters}
                        ...
                        <div className="3xl:w-[45%] order-2 lg:order-2 ">
                          <CandidatesMain
                            activeTab={activeTab}
                        ...
                        <div className="3xl:w-[30%] order-3 sticky top-16 self-start will-change-transform">
                          <CandidateDetail
