...
export const actionReviewCandidates: ActionReviewCandidate[] = [
    {
        ...
        matchPercentage: 95,
        aiSummary: 'Ram Gupta is an exceptional match for this role due to his extensive experience in scaling infrastructure using Terraform and managing complex Kubernetes clusters. His past roles show a strong emphasis on automation and security, perfectly aligning with the team\'s current roadmap.',
        experience: '8+ Years',
    ...
    },
    {
        ...
        source: 'LinkedIn',
        skills: ['Jenkins', 'Docker', 'AWS', 'Python'],
        matchPercentage: 88,
        aiSummary: 'Priya brings extensive CI/CD pipeline expertise with Jenkins and Docker. Her background in automating cloud infrastructure on AWS makes her a strong fit for the DevOps requirements.',
        experience: '6 Years',
    ...
    },
    {
        ...
        source: 'Referral',
        skills: ['Ansible', 'Terraform', 'GCP', 'Monitoring'],
        matchPercentage: 82,
        aiSummary: 'Alex has deep knowledge in infrastructure automation with Ansible and Terraform. His experience with GCP-based architectures and monitoring tools like Datadog and Prometheus is valuable.',
        experience: '5 Years',
    ...
    },
    {
        ...
        source: 'Indeed',
        skills: ['Kubernetes', 'Helm', 'ArgoCD', 'Azure'],
        matchPercentage: 78,
        aiSummary: 'Jordan specializes in Kubernetes orchestration and GitOps workflows using ArgoCD and Helm. His Azure DevOps experience complements the team\'s multi-cloud strategy.',
        experience: '7 Years',
        noticePeriod: 'Immediate',
    },
];
...
export const newMatchCandidates: NewMatchCandidate[] = [
    {
        ...
        skills: ['Docker', 'Kubernetes', 'Terraform', 'AWS'],
        matchPercentage: 95,
        aiSummary: 'Ram is an exceptional match for this role due to his deep expertise in container orchestration (Kubernetes) and infrastructure as code (Terraform). His extensive background in scaling high-availability CI/CD pipelines aligns perfectly with our core technical requirements.',
        experience: '8+ Years',
        noticePeriod: 'Immediate',
    },
    {
        ...
        source: 'LinkedIn',
        skills: ['Terraform', 'AWS', 'Python', 'CI/CD'],
        matchPercentage: 91,
        aiSummary: 'Sarah\'s strong background in infrastructure as code and her proven track record of building CI/CD pipelines at scale make her a prime candidate. Her Python scripting skills add extra value for automation tasks.',
        experience: '7 Years',
    ...
    },
    {
        ...
        matchPercentage: 87,
        aiSummary: 'David brings solid Linux systems expertise and has configured complex Jenkins pipelines. His Ansible automation skills and Docker containerization experience align well with the role requirements.',
        experience: '6 Years',
        noticePeriod: '30 Days',
    },
    {
...
export const scheduleEventsData: ScheduleEventData[] = [
    {
        id: 'se-1',
        title: '1st Technical Interview: Sarah Jenkins',
        candidateName: 'Sarah Jenkins',
        interviewType: '1st Technical Interview',
        date: 'Oct 25, 2023',
