    ...
    },
    {
      ...
      stageData: {
        aiInterview: {
          ...
          questions: ['Explain React hooks', 'How do you optimize React performance?'],
          notes: ['Good React knowledge', 'Needs improvement in advanced concepts']
        }
      }
    }
  ],
  'Shortlisted': [
    {
      ...
      stageData: {
        shortlisted: {
          ...
          questions: ['Explain CI/CD pipeline', 'How do you handle infrastructure scaling?'],
    ...
    },
    {
      ...
      stageData: {
        shortlisted: {
          ...
          questions: ['Explain test automation strategy', 'How do you handle flaky tests?'],
  ...
  'First Interview': [
    {
      ...
      positions: [{
        ...
        isCurrent: true,
        location: 'Bangalore',
        description: 'Developing mobile applications for ride-sharing platform'
      }],
      educations: [{
      ...
      stageData: {
        firstInterview: {
          ...
          interviewNotes: ['Good mobile development experience', 'Strong problem-solving skills'],
    ...
    },
    {
      ...
      stageData: {
        firstInterview: {
          followups: ['Arrange case study discussion', 'Connect with domain expert'],
          interviewNotes: ['Strong analytical skills', 'Good business understanding'],
  ...
  'Other Interviews': [
    {
      ...
      stageData: {
        otherInterviews: {
          ...
          interviewNotes: ['Excellent architecture knowledge', 'Strong leadership potential'],
    ...
    },
    {
      ...
      stageData: {
        otherInterviews: {
          ...
          interviewNotes: ['Strong agile experience', 'Good team management skills'],
  ...
  'HR Round': [
    {
      ...
      stageData: {
        hrRound: {
          ...
          interviewNotes: ['Strong cultural fit', 'Excellent communication skills'],
    ...
    },
    {
      ...
      stageData: {
        hrRound: {
          followups: ['Final approval', 'Offer preparation'],
          interviewNotes: ['Strong finance background', 'Good analytical skills'],
  ...
  'Salary Negotiation': [
    {
      ...
      stageData: {
        salaryNegotiation: {
          ...
          interviewNotes: ['Strong technical leadership', 'Good team management'],
    ...
    },
    {
      ...
      stageData: {
        salaryNegotiation: {
          ...
          interviewNotes: ['Excellent operations experience', 'Strong leadership skills'],
  ...
  'Offer Sent': [
    {
      ...
      stageData: {
        offerSent: {
          ...
          interviewNotes: ['Excellent strategic thinking', 'Strong consulting background'],
    ...
    },
    {
      ...
      stageData: {
        archived: {
          ...
          notes: ['Received counter offer', 'Decided to stay with current company']
        }
      }
    }
  ]
