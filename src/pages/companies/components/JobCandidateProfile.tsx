              ...
              {quickFitSummary.map((item: any, i: number) => {
                ...
                return (
                  ...
                  >
                    ...
                    {item.color === "yellow" && (
                      <svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M5.5 0.846153C2.92975 0.846153 0.846153 2.92975 0.846153 5.5C0.846153 8.07026 2.92975 10.1538 5.5 10.1538C8.07026 10.1538 10.1538 8.07026 10.1538 5.5C10.1538 2.92975 8.07026 0.846153 5.5 0.846153ZM0 5.5C0 2.46243 2.46243 0 5.5 0C8.53754 0 11 2.46243 11 5.5C11 8.53754 8.53754 11 5.5 11C2.46243 11 0 8.53754 0 5.5Z" fill="#CD9B05"/>
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M5.5 3C5.77613 3 6 3.18315 6 3.40909V5.59088C6 5.81684 5.77613 6 5.5 6C5.22387 6 5 5.81684 5 5.59088V3.40909C5 3.18315 5.22387 3 5.5 3Z" fill="#CD9B05"/>
                      <path d="M6 7.49998C6 7.77614 5.77613 8 5.5 8C5.22387 8 5 7.77614 5 7.49998C5 7.22386 5.22387 7 5.5 7C5.77613 7 6 7.22386 6 7.49998Z" fill="#CD9B05"/>
                      </svg>
