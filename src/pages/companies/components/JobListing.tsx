                            ...
                            <tr>
                                {columnsToRender.map(col => {
                                    ...
                                    return (
                                        <th
                                            key={col.key}
                                            className={`px-4 py-3 text-[11px] font-semibold uppercase text-[#AEAEB2] tracking-wider ${col.key !== 'jobTitle' ? 'text-center' : ''} ${col.key !== 'pipelineStage' ? 'text-center' : ''} whitespace-nowrap`}
                                        >
                                            <div
