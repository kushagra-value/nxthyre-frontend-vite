            ...
            <div className={`${selectedPreset === "Custom Date" ? "w-[190px] border-r border-[#D1D1D6]" : "w-full"} p-3`}>
              ...
              {selectedPreset === "Custom Date" && (
                <button
                  ...
                  disabled={!startDate}
                  className="mt-6 mx-3 px-6 py-2.5 bg-[#0F47F2] text-white rounded-[10px] text-[15px] font-medium disabled:opacity-50"
                >
                  Apply
                </button>
              )}
            ...
            {selectedPreset === "Custom Date" && (
              <div className="flex-1 p-5">
                <div className="flex items-center justify-between mb-6">
                  <span className="text-[34px] leading-[38px] font-normal text-[#4B5563]">
                ...
                <div className="grid grid-cols-7 gap-y-2">
                  {["MO", "TU", "WE", "TH", "FR", "SA", "SU"].map((day) => (
                    <div key={day} className="h-9 flex items-center justify-center text-[18px] leading-[22px] text-[#9CA3AF]">
                      {day}
                    </div>
                  ))}
...
export default JobDateRangeFilter;
