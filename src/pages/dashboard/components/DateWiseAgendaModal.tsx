        ...
        return (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-sm p-6">
                <div className="bg-white w-full max-w-2xl rounded-2xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col">
                    <div className="p-8 pb-5 border-b border-slate-100 flex justify-between items-start">
                        <h2 className="text-2xl font-bold tracking-tight text-slate-900">No Agenda Data</h2>
                    ...
                    <div className="p-6 flex items-center justify-center py-12 text-sm text-[#8E8E93]">
                        No agenda items found for this date.
                    </div>
                </div>
            </div>
        );
                ...
                {isLoading ? renderLoading() : (
                    <div className="p-6 space-y-4 flex-1 overflow-y-auto max-h-[calc(100vh-300px)]">
                        ...
                        <div className="flex gap-3 items-stretch">
                                    ...
                                    <div className="flex items-center gap-2.5 mb-3">
                                        <div className="flex -space-x-2 shrink-0">
                                            <div
                                                ...
                                                style={{ backgroundImage: agenda.live_status.interviewer_avatar ? `url('${agenda.live_status.interviewer_avatar}')` : undefined }}
                                            />
                                        ...
                                        <div>
                                            <p className="text-slate-900 font-bold text-xs leading-tight">
                                                {agenda.live_status.interviewer_name} → {agenda.live_status.candidate_name}
                                            </p>
                                            <p className="text-[10px] font-medium text-slate-500">{agenda.live_status.round_type} • {agenda.live_status.elapsed} elapsed</p>
                                        </div>
                                    </div>
                            ...
                            {agenda?.alerts && agenda.alerts.length > 0 && (
                                <div className="flex flex-col gap-2 w-[200px] shrink-0">
                                    {agenda.alerts.map((alert) => (
                                        ...
                                        >
                                            ...
                                            <p className="text-xs font-bold text-slate-900 leading-tight mb-2">{alert.candidate_name}</p>
                                            {alert.type === 'soon' ? (
                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div className="flex-1 min-w-0">
                                                            <div className="flex items-center justify-between gap-2">
                                                                <h4 className="font-bold text-xs text-slate-700 truncate">{item.candidate_name}</h4>
                                                            ...
                                                            <div className="flex items-center justify-between mt-0.5">
                                                                <p className="text-[10px] text-slate-400 truncate">{item.candidate_role}</p>
                                            ...
                                            return (
                                                <div key={item.id} className="bg-white border-2 border-blue-600/20 rounded-lg px-4 py-3 shadow-md shadow-blue-600/5 relative overflow-hidden">
                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div className="flex-1 min-w-0">
                                                            <div className="flex items-center justify-between gap-2">
                                                                <h4 className="font-bold text-xs text-slate-900 truncate">{item.candidate_name}</h4>
