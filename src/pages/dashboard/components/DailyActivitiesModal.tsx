...
const DailyActivitiesModal: React.FC<DailyActivitiesModalProps> = ({ isOpen, onClose }) => {
    ...
    const CallCancelIcon = (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
            <path d="M21.97 18.33C21.97 18.69 21.89 19.06 21.72 19.42C21.55 19.78 21.33 20.12 21.04 20.44C20.55 20.98 20.01 21.37 19.4 21.62C18.8 21.87 18.15 22 17.45 22C16.43 22 15.34 21.76 14.19 21.27C13.04 20.78 11.89 20.12 10.75 19.29C9.6 18.45 8.51 17.52 7.47 16.49C6.44 15.45 5.51 14.36 4.68 13.22C3.86 12.08 3.2 10.94 2.71 9.8C2.22 8.66 1.98 7.57 1.98 6.54C1.98 5.84 2.11 5.2 2.36 4.59C2.61 3.99 2.99 3.44 3.53 2.96C3.86 2.66 4.2 2.45 4.56 2.27C4.92 2.1 5.29 2.02 5.65 2.02C5.97 2.02 6.27 2.09 6.54 2.22C6.81 2.35 7.03 2.54 7.21 2.78L9.54 5.89C9.72 6.14 9.85 6.38 9.94 6.6C10.03 6.82 10.08 7.02 10.08 7.21C10.08 7.43 10.01 7.64 9.88 7.85C9.75 8.06 9.58 8.25 9.38 8.44L8.43 9.42C8.31 9.55 8.25 9.69 8.25 9.84C8.25 9.93 8.26 10.01 8.29 10.09C8.32 10.17 8.35 10.25 8.39 10.33C8.75 11.02 9.22 11.72 9.77 12.44C10.33 13.16 10.94 13.88 11.62 14.61C12.3 15.33 12.98 15.98 13.67 16.54C14.36 17.09 15.01 17.51 15.63 17.82C15.72 17.87 15.8 17.91 15.89 17.94C15.97 17.97 16.06 17.98 16.15 17.98C16.3 17.98 16.44 17.92 16.57 17.8L17.55 16.85C17.74 16.66 17.93 16.48 18.15 16.36C18.36 16.23 18.57 16.16 18.78 16.16C18.98 16.16 19.18 16.21 19.4 16.3C19.62 16.39 19.86 16.53 20.11 16.71L23.22 19.04C23.46 19.22 23.65 19.44 23.78 19.72C23.91 19.99 23.98 20.29 23.98 20.61C23.98 20.91 23.9 21.21 23.75 21.46L21.97 18.33ZM15 3L9 9" fill="currentColor" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        </svg>
    );
    ...
    const activitiesList = [
        {
            title: "Called Max Verstappen",
            time: "Screening · 9:00 AM",
            type: "call",
            iconBg: "#E7EDFF",
            iconColor: "#0F47F2",
            icon: PhoneIcon,
        ...
        {
            title: "Follow-up — Mark Anderson",
            time: "Sourcing · 10:25 AM",
            type: "follow-up",
            iconBg: "#FEF3C7",
            iconColor: "#FF8D28",
            icon: BellIcon,
        ...
        },
        {
            ...
            time: "Shortlisted · 10:45 AM",
            type: "shortlist",
            iconBg: "#D1FAE5",
            iconColor: "#059669",
            icon: StarIcon,
            pillText: "Shortlisted",
            pillTextCol: "#059669",
            pillBg: "#D1FAE5",
        },
        {
            title: "Called Dwija Patel",
            time: "Interview · 11:30 AM",
            type: "call",
            iconBg: "#E7EDFF",
            iconColor: "#0F47F2",
            icon: PhoneIcon,
        ...
        {
            title: "Arjun Kapoor — Offer Accepted!",
            titleCol: "#6155F5",
            time: "Interview · 11:30 AM",
            type: "hired",
            iconBg: "#E7EDFF",
        ...
        {
            title: "Follow-up — Kavya Sharma",
            time: "Shortlisted · 5:30 PM",
            type: "follow-up",
            iconBg: "#FEF3C7",
            iconColor: "#FF8D28",
            icon: BellIcon,
        ...
        {
            title: "Priya Patel → Screening",
            time: "Round 2 · 1:15 PM",
            type: "moved",
            iconBg: "#D6FFFF",
            iconColor: "#00C3D0",
        ...
        {
            title: "Robert Pattinson → Round 2",
            time: "Round 2 · 1:15 PM",
            type: "moved",
            iconBg: "#D6FFFF",
            iconColor: "#00C3D0",
        ...
        {
            title: "Called Toto Wolf",
            time: "Not answered · 10:45 AM",
            timeCol: "#DC2626",
            type: "call-cancel",
            iconBg: "#FEE2E2",
            iconColor: "#DC2626",
            icon: CallCancelIcon,
            pillText: "Follow Up Scheduled",
            pillTextCol: "#FF8D28",
            pillBg: "#FEF3C7",
        },
    ];
                ...
                <div className="shrink-0 w-full" style={{ padding: '20px 24px', borderBottom: '0.5px solid #AEAEB2' }}>
                    <div className="flex items-center justify-between bg-gray-50" style={{ padding: '20px', borderRadius: 10 }}>
                        <div className="flex flex-col gap-[7px]">
                            ...
                            <span className="font-normal text-gray-600" style={{ fontSize: 20, lineHeight: '24px' }}>5</span>
                        </div>
                        <div className="flex flex-col gap-[7px]">
                            ...
                            <span className="font-normal text-gray-600" style={{ fontSize: 20, lineHeight: '24px' }}>3</span>
                        </div>
                        <div className="flex flex-col gap-[7px]">
                        ...
                        <div className="flex flex-col gap-[7px]">
                            ...
                            <span className="font-normal text-gray-600" style={{ fontSize: 20, lineHeight: '24px' }}>1</span>
                        </div>
                    </div>
                </div>
                            ...
                            <div key={index} className="flex items-center justify-between w-full">
                                <div className="flex items-center gap-[12px]">
                                    ...
                                    <div className="flex flex-col gap-[2px]">
                                        <span className="font-normal" style={{ fontSize: 14, lineHeight: '17px', color: act.titleCol || '#111827' }}>
                                            {act.title}
                                        </span>
                                        <span className="font-normal" style={{ fontSize: 12, lineHeight: '14px', color: act.timeCol || '#AEAEB2' }}>
                                            {act.time}
                                        </span>
                                    </div>
                                </div>
