...
const ActionReviewModal: React.FC<ActionReviewModalProps> = ({
    ...
    const shouldShowMoveToNextRound =
        (tab === 'screening' && tags.some(t => t.toLowerCase().includes('not moved') && t.toLowerCase().includes('move to next round'))) ||
        (tab === 'interview' && tags.some(t => t.toLowerCase().includes('interview feedback pending') && t.toLowerCase().includes('move to next round')));
    ...
    const handleArchive = async () => {
        ...
        try {
            ...
            if (archiveStageId) {
                await apiClient.patch(`/jobs/applications/${currentItem.application_id}/`, {
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <span style={{ fontSize: 14, lineHeight: '17px', fontWeight: 400, color: '#FF383C' }}>
                        ...
                        <div className="flex items-center" style={{ gap: 10 }}>
                            ...
                            {shouldShowMoveToNextRound && (
                                ...
                                >
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M3.33398 8H12.6673" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
                                        <path d="M8.66732 4L12.6673 8L8.66732 12" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
                                    <span style={{ fontSize: 14, lineHeight: '17px', fontWeight: 400, color: '#FFFFFF' }}>
                            ...
                            {!shouldShowCallButton && !shouldShowMoveToNextRound && (
                                ...
                                >
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M3.33398 8.66663L6.00065 11.3333L12.6673 4.66663" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
                                    <span style={{ fontSize: 14, lineHeight: '17px', fontWeight: 400, color: '#FFFFFF' }}>
