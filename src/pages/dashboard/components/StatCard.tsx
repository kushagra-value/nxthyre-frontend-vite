...
const BuildingIcon = (
  <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M28.6667 28.6667H12" stroke="#0F47F2" strokeLinecap="round" />
    ...
    <path d="M17.8335 28.6667V26.1667" stroke="#0F47F2" strokeLinecap="round" />
      ...
      <div className="flex justify-between items-center w-full z-10">
        ...
        {trend && trendText && (
          <div className="flex items-center">
            ...
            <ArrowUpRight className="w-3 h-3" style={{ color: color, transform: isPositive ? 'none' : 'rotate(90deg)' }} />
            <span
