        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 relative overflow-hidden rounded-xl">
            <div className="space-y-8 pb-4">
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                  ...
                  <button 
                    ...
                    className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg font-medium text-sm transition-colors shadow-sm self-start"
                  >
                    Message Recruiter
                  </button>
                </div>
              ...
              <div className="text-xs font-bold text-gray-400 tracking-widest uppercase mb-4 px-2">My Details</div>
