...
export default function Companies() {
    ...
    if (selectedWorkspace) {
        return (
            <div className="flex-1 flex overflow-hidden bg-[#F3F5F7]">
                <div className={`flex-1 overflow-y-auto p-4 custom-scrollbar flex flex-col gap-4 transition-all ${infoWorkspace ? 'hidden lg:flex' : 'flex'}`}>
                    {/* ── Company Info Card ── */}
                ...
                {infoWorkspace && (
                    <aside className="w-[500px] shrink-0 bg-white border-l border-[#D1D1D6] flex flex-col z-10 transition-all shadow-xl overflow-y-auto">
                        <CompanyInfoTab
    ...
    return (
        <div className="flex-1 flex overflow-hidden bg-[#F3F5F7]">
            <div className={`flex-1 overflow-y-auto p-4 custom-scrollbar transition-all ${infoWorkspace ? 'hidden xl:block' : 'block'}`}>
                                                                    ...
                                                                    >
                                                                        <button
                                                                            onClick={() => {
                                                                                ...
                                                                                setInfoWorkspace(match || { id: row.workspaceId, name: row.name, company_research_data: { company_name: row.name } as any } as any);
                                                                            }}
